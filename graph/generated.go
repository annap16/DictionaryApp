...
type ComplexityRoot struct {
	...
	Query struct {
		GetWordTranslation func(childComplexity int, word string) int
	}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]any) (int, bool) {
	...
	case "Mutation.addExample":
		...
		args, err := ec.field_Mutation_addExample_args(context.TODO(), rawArgs)
		if err != nil {
			return 0, false
		}
	...
	case "Mutation.deleteWord":
		...
		return e.complexity.Mutation.DeleteWord(childComplexity, args["word"].(string)), true
	...
	case "Query.getWordTranslation":
		...
		return e.complexity.Query.GetWordTranslation(childComplexity, args["word"].(string)), true
...
func (ec *executionContext) field_Mutation_addTranslation_args(ctx context.Context, rawArgs map[string]any) (map[string]any, error) {
	var err error
	args := map[string]any{}
	arg0, err := ec.field_Mutation_addTranslation_argsInput(ctx, rawArgs)
	if err != nil {
		return nil, err
	}
	args["input"] = arg0
...
func (ec *executionContext) _Mutation_addExample(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	fc, err := ec.fieldContext_Mutation_addExample(ctx, field)
	if err != nil {
		return graphql.Null
	}
	ctx = graphql.WithFieldContext(ctx, fc)
...
func (ec *executionContext) _Mutation_deleteWord(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (any, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().DeleteWord(rctx, fc.Args["word"].(string))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _Query_getWordTranslation(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (any, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Query().GetWordTranslation(rctx, fc.Args["word"].(string))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
